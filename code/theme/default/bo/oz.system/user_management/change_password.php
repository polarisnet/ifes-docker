	...
	<table>
		<tr>
			<td colspan="2" style="text-align: center;">
				...
				<input type="button" value="Back" class="flat-button-default" onclick="javascript: window.location='<?php echo getModuleURL('oz.dashboard'); ?>';">
			</td>
		</tr>
		<tr>
			<td class="lbl-title" colspan="2">Change Password<span class="compulsory-text"><span class="lbl-compulsory">*</span> Required Information</span></td>
		</tr>
		<tr>
			<td class="form-spacer1">
				<table>					
                    ...
                    <tr>
						<td class="lbl-field">Current Password</td>
						<td><div class="lbl-compulsory">*</div></td>
						<td><input type="password" class="flat-input" id="current_password" name="current_password" onkeydown="javascript:calculateComplexity();"></td>
					</tr>
                    <tr>
					...
					<tr>
						...
						<td><div class="lbl-compulsory">*</div></td>
						<td><input type="password" class="flat-input" id="retype_password" name="retype_password" onblur="javascript: validateMatch($('#password'), $('#retype_password'), 'new password', 'retype password');"></td>
					</tr>
					<tr>
...
<script type="text/javascript">		
	function submitForm(mode){
		...
		if(!validateEmpty($('#current_password'), 'current password')){return;}
		if(!validateEmpty($('#password'), 'new password')){return;}
