...
<script type="text/javascript" src="<?php echo HTTP_ACTIVE_THEME; ?>/oz.system/logs/list_audit.js"></script>
...
<script type="text/javascript">
		...
		return{
			init: function(){
				...
				var listPanel = new ListPanel({
					...
					'viewLink': '<?php echo getModuleURL('oz.system.logs.audit.view'); ?>'
				});
	...
	Ext.onReady(Audit.app.init, Audit.app);
</script>