	...
	<table style="position: relative;">
		<tr>
			<td colspan="2" style="text-align: center;">
				...
				<input type="button" value="Back" class="flat-button-default" rel="tooltip" data-original-title="<?php echo SHORTCUT_BACK; ?>" data-placement="top" onclick="javascript: window.location='<?php echo getModuleURL('oz.system.settings.profile'); ?>';">
			</td>
		</tr>
		<tr>
			<td colspan="2">
