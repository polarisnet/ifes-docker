...
Ext.define('DetailsListPanel', {
	...
	constructor: function(config){
				...
				handler: function(){
					...
					submitRequest.request({
						...
						success: function(response){
							...
							Ext.Msg.alert('Sales Order Details', '<p class="fix-x-multiline-msg">'+feedback.message+'</p>');
							if(feedback.success){
								detailsWindow.hide();
								listStore.reload();
							}
						...
						failure: function(response){
							Ext.Msg.alert('Sales Order Details', 'Oops.. something wrong with the connection to server. Please try again.');
						}
					});
				}
			},{
		...
		DetailsListPanel.superclass.constructor.call(this, {
			id: 'grid_custom_option_content_listing',
			height: 400,
			dockedItems:[{
				xtype: 'toolbar',
enableOverflow: true,
				...
				items:[{
					...
					id: "btnResetGridViewCustomDetails",
					...
					pressed: false,
					handler: function(){
						gridDeleteState('custom_option_content_listing', JS_USERID, this, listStore);
					},
					scope: this
				}]
			},{
...
enableOverflow: true,
			...
			stateful: true,
			stateId: 'sm_custom_option_content_listing',
			...
			listeners:{
				...
				statesave: function (objInit, state, eOpts) {
					if(!objInit.isStateRestoring) {
						gridSaveState('custom_option_content_listing', JS_USERID, this, listStore);
					}
				...
				render: function (objInit) {
					...
					gridRestoreState('custom_option_content_listing', JS_USERID, this, listStore);
				},
