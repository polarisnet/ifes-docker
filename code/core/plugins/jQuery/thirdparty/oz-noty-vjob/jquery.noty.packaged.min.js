    ...
    return a.noty.consumeAlert = function(b) {
        ...
        style: function() {
            switch (this.$bar.css({
                ...
                width: 16,
                height: 16,
                background: "url(data:image/png;base64,)",
                cursor: "pointer"
            }), this.$buttons.css({
                padding: 5,
                textAlign: "right",
        ...
        style: function() {
            ...
            switch (this.options.type) {
                ...
                case "error":
                    this.$bar.css({
                        backgroundColor: "#eb5e36"
                    });
                    break;
                case "information":
                    this.$bar.css({
                        backgroundColor: "#61b23d"
                    });
                    break;
                case "success":
                    this.$bar.css({
